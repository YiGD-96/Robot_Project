...
class YoloDetect(Node):
    def __init__(self):
        ...
        self.img_publisher_ = self.create_publisher(CompressedImage, 'yolo_image/compressed', 1)
        self.info_publisher_ = self.create_publisher(String, 'yolo_image/detected_info', 5)
